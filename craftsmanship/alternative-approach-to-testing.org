...
- Take a good look at the tests for which bits of the functionality usage are clunky. Improve the code until it is no longer embarrassing. This probably will require you to revise the earlier stages.
